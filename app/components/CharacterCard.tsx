            ...
            {data?.slice(0, 20).map((p: any) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-900 rounded-lg hover:bg-yellow-800  dark:bg-blue-600 dark:hover:bg-yello-700 dark:focus:ring-yellow-800"
                  >
                    Read more
                    <svg
